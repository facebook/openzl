...
#ifndef ZSTRONG_TRANSFORMS_BITSPLIT_DECODE_BITSPLIT_BINDING_H
#define ZSTRONG_TRANSFORMS_BITSPLIT_DECODE_BITSPLIT_BINDING_H
...
#endif // ZSTRONG_TRANSFORMS_BITSPLIT_DECODE_BITSPLIT_BINDING_H
