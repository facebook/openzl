...
static inline const char* SDDL2_instruction_name_impl(uint16_t family, uint16_t opcode)
{
    switch (family) {
        ...
        case SDDL2_FAMILY_SEGMENT:
            switch (opcode) {
                case SDDL2_OP_SEGMENT_CREATE_UNSPECIFIED: return "segment.create_unspecified";
                case SDDL2_OP_SEGMENT_CREATE_TAGGED: return "segment.create_tagged";
