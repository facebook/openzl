...
// instead of being blocked. What rides on that here is the font: `index.css`
// pulls it in with a CSS `@import`, which cannot carry `crossorigin`, so under
// `require-corp` it would pass only if fonts.googleapis.com sent CORP.
