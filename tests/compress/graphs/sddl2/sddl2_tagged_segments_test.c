...
static void test_create_single_tagged_segment(void)
{
    ...
    SDDL2_Stack_push(stack, SDDL2_Value_type((SDDL2_Type){ SDDL2_TYPE_U8, 1, NULL }));
...
static void test_tagged_segment_size_overflow(void)
{
    ...
    SDDL2_Stack_push(stack, SDDL2_Value_tag(100));
    SDDL2_Stack_push(
            stack, SDDL2_Value_type((SDDL2_Type){ SDDL2_TYPE_I64LE, 1, NULL }));
...
static void test_tagged_segment_wrong_type_size(void)
{
    ...
    SDDL2_Stack_push(
            stack,
            SDDL2_Value_type(
                    (SDDL2_Type){ SDDL2_TYPE_U8, 1, NULL })); // type (correct)
    SDDL2_Stack_push(
...
static void test_many_tags_registry_growth(void)
{
    ...
    for (int i = 0; i < 50; i++) {
        ...
        SDDL2_Stack_push(
                stack,
                SDDL2_Value_type((SDDL2_Type){ SDDL2_TYPE_U8, 1, NULL })); // type
...
static void test_segment_list_growth_different_types(void)
{
    ...
    for (int i = 0; i < NUM_SEGMENTS; i++) {
        ...
        SDDL2_Stack_push(
                stack, SDDL2_Value_type((SDDL2_Type){ types[type_idx], 1, NULL }));
