...
#define EI_TOKENIZE_STRUCT(id)                                                \
    {                                                                         \
        .gd = TOKENIZE_GRAPH(id, ZL_Type_struct), .transform_f = EI_tokenize, \
        .name = "!zl.tokenize_struct"                                         \
    }

#define EI_TOKENIZE_NUMERIC(id)                                                \
    {                                                                          \
        .gd = TOKENIZE_GRAPH(id, ZL_Type_numeric), .transform_f = EI_tokenize, \
...
#define EI_TOKENIZE_STRING(id)                                       \
    {                                                                \
        ...
        .transform_f = EI_tokenizeVSF, .name = "!zl.tokenize_string" \
    }
